    ...
    <div className="flex flex-col lg:grid lg:grid-flow-col lg:grid-cols-2  gap-10">
      <div className="h-100 flex flex-col justify-center">
        ...
        <div className="gap-5 inline-flex justify-center w-full my-4">
          <PrimaryButton type="View Projects" hyper="https://github.com/Sanjaygenius777?tab=repositories" isOn={true}/>
      ...
      <div className="flex flex-col items-center lg:flex-row lg:items-start w-full justify-center gap-10">
        <div className="flex flex-col items-start gap-4 px-3">
          ...
          <div className="flex flex-col gap-3" >
            <ContactButton via="Instagram" hyper="https://www.instagram.com/hashsanjayp">
            <FaInstagram />
          </ContactButton >
          <ContactButton via="LinkedIn" hyper="https://www.linkedin.com/in/hashsanjayp">
            <FaLinkedinIn/>
          </ContactButton>
          <ContactButton via="Reddit" hyper="https://www.reddit.com/u/san_patel/s/ozuxCd1XgW">
            <FaReddit />
          </ContactButton>
          </div>
        </div>
        <div className="flex flex-col items-start">
          ...
          <form className="grid grid-flow-row grid-rows-1" onSubmit={onSend}>
            ...
            <input className="name-area" type="text" name="name" required placeholder="Enter your name"></input>
            <textarea className="form-area " name="message" placeholder="Enter your Message!" required></textarea>
